...
x86Emulator::UWP::Native::IntPtr D3D11Interop::GetD3D11Device(CanvasDrawingSession^ drawingSession)
{
	return (IntPtr)GetD3D11DevicePtr(drawingSession);
}

x86Emulator::UWP::Native::IntPtr D3D11Interop::GetD3D11Context(CanvasDrawingSession^ drawingSession)
{
