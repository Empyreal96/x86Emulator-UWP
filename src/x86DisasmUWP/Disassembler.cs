...
namespace x86Disasm
{
    public partial class Disassembler
    {
        ...
        public int Disassemble(uint addr, bool doStrings)
        {
            ...
            {
                Helpers.ErrorLog?.Invoke("Invalid operation", null);
            }
            return (int)offset;
        }
        ...
        public void Execute(params Operand[] operands)
        {
            ...
            if (!operations.TryGetValue(currentInstruction.OpCode, out operation))
                Helpers.ErrorLog?.Invoke($"Instruction not implemented: {currentInstruction.OpCode}", null);
            ...
            switch (operation.NumberOfArgs)
            {
                case 0:
                    ...
                    {
                        Helpers.ErrorLog?.Invoke($"Function (func) not available", null);
                    }
                    break;
                case 1:
                    ...
                    {
                        Helpers.ErrorLog?.Invoke($"Function (func1) not available", null);
                    }
                    break;
                case 2:
                    ...
                    {
                        Helpers.ErrorLog?.Invoke($"Function (func2) not available", null);
                    }
                    break;
                case 3:
                    ...
                    {
                        Helpers.ErrorLog?.Invoke($"Function (func3) not available", null);
                    }
                    break;
            }
        }
